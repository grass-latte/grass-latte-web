...
export function sampleTree() {
    ...
    tree.addElement(["Alpha", "Bravo", "Hotel"], new TextElement("Hotel", {text: "hotel:", card: false}));
    tree.addElement(["Alpha", "Bravo", "Hotel", "Whiskey"], new TextElement("Whiskey", {text: "whiskey", card: false}));
    tree.addElement(["Alpha", "Bravo", "Juliet"], new ProgressElement("Juliet", {text: "juliet", progress: 0.4, card: true}));
